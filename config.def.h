...
static const char fg_color[]       = "#ebdbb2";
static const char accent_color[]        = "#8ec07c";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { fg_color, bg_color, bg_color },
	[SchemeSel]  = { bg_color, accent_color, accent_color },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", bg_color, "-nf", fg_color, "-sb", accent_color, "-sf", bg_color, NULL };
